/**
 * Prompt Configuration and Management for Macro Indicators Analysis Service
 * Handles loading, versioning, and templating of macro analysis prompts
 */

const fs = require("fs");
const path = require("path");

class MacroPromptManager {
  constructor() {
   ...
   * @param {string} promptName - Name of the prompt (e.g., 'macro-analysis')
   * @param {string} version - Version (e.g., 'v1', 'v2')
   * @returns {string} Raw prompt template
   */
  loadPromptTemplate(promptName = "macro-analysis", version = null) {
   ...
   */
  getFilledPrompt(templateData, promptName = "macro-analysis", version = null) {
   ...
   */
  getAvailableVersions(promptName = "macro-analysis") {
    try {
...
module.exports = MacroPromptManager;
